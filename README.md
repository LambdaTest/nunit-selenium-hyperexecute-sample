# Run Selenium Tests with NUnit on HyperExecute with TestMu AI (Formerly LambdaTest)
...
```bash
git clone https://github.com/LambdaTest/nunit-selenium-hyperexecute-sample && cd nunit-selenium-hyperexecute-sample
```
